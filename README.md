...
| [docs/quiz-versioning-and-archiving.md](docs/quiz-versioning-and-archiving.md) | Согласованная последующая модель карточки, внутренних версий, предпросмотра, архивирования и сохранения игровой истории; пока не реализована |
...
Любая связанная сессия навсегда запрещает изменение/удаление использованной викторины и содержимого; история защищена от прямого и каскадного удаления. [Целевая модель версий и архивирования](docs/quiz-versioning-and-archiving.md) согласована, но пока не реализована. Локальная реализация А не является разрешением развёртывания.
