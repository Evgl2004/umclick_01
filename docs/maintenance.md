...
- Схема может быть структурно отменена и применена повторно только на пустых игровых таблицах в выделенной тестовой базе. Предпросмотр этим переключением не добавлен.
